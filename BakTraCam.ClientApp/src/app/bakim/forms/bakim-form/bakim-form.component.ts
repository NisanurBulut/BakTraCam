...
export class BakimFormComponent implements OnInit, AfterViewInit {
  ...
  public cancel(): void {
    if (!this.isClean()) {
      this.form.reset({
        ...
        Sorumlu1: this.data.Sorumlu1,
        Sorumlu2: this.data.Sorumlu2,
  ...
  createForm(): void {
    this.form = this.formBuilder.group({
      ...
      Sorumlu1: [this.data.Sorumlu1, [Validators.required, Validators.maxLength(50)]],
      Sorumlu2: [this.data.Sorumlu2, [Validators.required, Validators.maxLength(50)]],
